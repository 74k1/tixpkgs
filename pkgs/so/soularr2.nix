...
#  /nix/store/z7xxy35k7620hs6fn6la5fg2lgklv72l-python3-3.12.4/bin/python3.12 -m pip --disable-pip-version-check wheel --no-deps -w /build/tmph6sxw990 --quiet setuptools-git-versioning
